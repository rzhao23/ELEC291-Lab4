...
_LCDprint_PARM_2:
	ds 1
_float_to_str_PARM_2:
	ds 3
_float_to_str_number_1_65:
	ds 4
_float_to_str_temp_1_66:
	ds 16
_float_to_str_i_1_66:
	ds 1
_float_to_str_print_length_1_66:
	ds 1
_main_num_buff_1_73:
	ds 10
_main_print_buff_1_73:
	ds 17
;--------------------------------------------------------
...
L011011?:
	ret
;------------------------------------------------------------
;Allocation info for local variables in function 'float_to_str'
;------------------------------------------------------------
;buffer                    Allocated with name '_float_to_str_PARM_2'
;number                    Allocated with name '_float_to_str_number_1_65'
;number_holder             Allocated to registers r2 r3 
;temp                      Allocated with name '_float_to_str_temp_1_66'
;i                         Allocated with name '_float_to_str_i_1_66'
...
;	D:\Coding\2026\291\lab4\lab4.c:217: number_holder = (unsigned int)number;
	...
	mov	(_float_to_str_number_1_65 + 3),a
	lcall	___fs2uint
	mov	r6,dpl
	mov	r7,dph
	mov	ar2,r6
...
;	D:\Coding\2026\291\lab4\lab4.c:232: number_holder = (unsigned int)(number * 100) - (unsigned int)(number) * 100;
	...
	push	(_float_to_str_number_1_65 + 1)
	push	(_float_to_str_number_1_65 + 2)
	push	(_float_to_str_number_1_65 + 3)
	mov	dptr,#0x0000
	mov	b,#0xC8
	mov	a,#0x42
	lcall	___fsmul
...
;	D:\Coding\2026\291\lab4\lab4.c:244: buffer[j] = temp[i];
	...
	mov	r5,a
	clr	a
	addc	a,(_float_to_str_PARM_2 + 1)
	mov	r6,a
	mov	r7,(_float_to_str_PARM_2 + 2)
	mov	a,r3
	add	a,#_float_to_str_temp_1_66
	mov	r0,a
	mov	ar2,@r0
